...
const services = [
  { id: 1, name: "Konsultasi Statistik", icon: "👥", description: "Konsultasi mengenai statistik yang dihasilkan oleh BPS" },
  { id: 2, name: "Produk Statistik Berbayar", icon: "✅", description: "Akses data mikro, peta wilayah kerja statistik, dll." },
  { id: 3, name: "Rekomendasi Kegiatan Statistik", icon: "🔍", description: "Rekomendasi pelaksanaan kegiatan statistik" },
  { id: 4, name: "Layanan Perpustakaan", icon: "📖", description: "Akses publikasi BPS Provinsi Bali" },
];
